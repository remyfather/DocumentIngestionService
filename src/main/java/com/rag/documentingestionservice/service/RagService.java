...
public interface RagService {
    ...
    void processAndSaveChunkedData(ChunkedDataDto chunkedDataDto);
    CompletableFuture<String> processAndSaveChunkedDataAsync(UrlExtractRequestDto urlExtractRequestDto);
}
